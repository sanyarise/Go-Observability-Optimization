...
func sentryInit() error {
	err := sentry.Init(sentry.ClientOptions{
		Dsn: "https://2b31a885edd0419fb20b6aa0c8db4320@o1058306.ingest.sentry.io/6045875",
	})
	if err != nil {
	...
	sentry.CaptureMessage("Panic logged! See server log")
	return nil
}
...
func (a *app) Init(ctx context.Context, logger *logrus.Logger) error {
	...
	if err != nil {
		return fmt.Errorf("failed to parse connection string (%s): %w", DatabaseURL, err)
	}
